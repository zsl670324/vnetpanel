...
return [
    'panel'                           => 'コントロールパネル',
    'subscribe_address'               => 'サービス購読',
    'copy_subscribe_address'          => 'コピー',
    'exchange_subscribe'              => 'リセット',
    ...
    'subscribe_baned'                 => 'サービスが一時停止されました。管理人に連絡してください',
    'download'                        => 'ダウンロード',
    ...
    'account_total_traffic'           => '有効流量',
    'account_limit_speed'             => '速度を制限する',
    'account_usage_traffic'           => '使用済み',
    'account_reset_notice'            => '毎月 :reset_day 日にデータ通信量をリセットする',
    'account_login_log'               => '登録ログ',
    'account_access_log'              => 'アクセスログ',
    'account_disable_log'             => '禁ログ',
    'article_title'                   => '文章',
    'recharge'                        => 'チャージ',
    'enabled'                         => '有効',
    'disabled'                        => '無効',
    ...
    'ticket_table_new_desc'           => 'あなたの質問に記入してください。',
    ...
    'profile'                         => '個人設定',
    'logout'                          => 'ログアウト',
    'promote_link'                    => 'あなたの招待リンクを通じて登録し、招待された人の消費をアクティブにすると、彼らの消費金額の :referral_percent% を現金奨励として獲得します。',
    'promote_invite_code'             => '招待コードを通じて登録し、招待された人の消費をアクティブにすると、彼らの消費金額の :referral_percent% を現金ボーナスとして獲得します。',
