            ...
            <div class="col-md-12">
                <div class="portlet light portlet-fit bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject font-dark" style="ord-wrap: break-word;word-break: break-all;overflow: hidden;">#{{$ticket->id}} {{$ticket->title}} </span>
                        </div>
                        <div class="actions">
                            @if($ticket->status != 2)
                                    ...
                                    <div class="timeline-item">
                                        ...
                                        <div class="timeline-body">
                                            ...
                                            <div class="timeline-body-head">
                                                <div class="timeline-body-head-caption">
                                                    @if($reply->master)
                                                        <span class="timeline-body-alerttitle font-red-intense">{{empty($reply->master) ? '【管理员已删除】' : $reply->master->username}}</span>
                                                    @else
    ...
    <script type="text/javascript">
        ...
        function replyTicket() {
            ...
            layer.confirm('确定回复工单？', {icon: 3, title:'提示'}, function(index) {
                $.post("/admin/replyTicket",{_token:'{{csrf_token()}}', id:'{{$ticket->id}}', content:content}, function(ret) {
                    layer.msg(ret.message, {time:1000}, function() {
                        if (ret.status == 'success') {
