                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            <span class="caption-subject"> 用户订阅变更记录 </span>
                        </div>
                    </div>
                                    ...
                                    @else
                                        @foreach($list as $vo)
                                            <tr class="odd gradeX">
                                                ...
                                                <td> {{$vo->after}} </td>
                                                <td> {{$vo->created_at}} </td>
                                                <td> {!! empty($vo->user) ? '【账号已删除】' : $vo->user->enable_label !!} </td>
                                            </tr>
                                        @endforeach
                                    @endif
                                </tbody>
...
@section('script')
    <script type="text/javascript">
        ...
        function doSearch() {
            ...
            window.location.href = '/admin/userSubscribeExList?username=' + username;
        }

        // 重置
        function doReset() {
            window.location.href = '/admin/userSubscribeExList';
        }
    </script>
@endsection
