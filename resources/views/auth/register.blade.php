...
@endsection
@section('content')
    @if(\App\Components\Helpers::getNotice())
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-info">
                    {!! \App\Components\Helpers::getNotice() !!}
                </div>
            </div>
        </div>
    @endif
    ...
    <form class="register-form" id="register-form" action="/register" method="post" style="display: block;">
        @if(\App\Components\Helpers::systemConfig()['is_register'])
                ...
                <div class="form-group">
                    <div class="row form-inline">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <select class="form-control" name="domain" id="domain" style="width:100%; min-width:auto; max-width: 185px;">
            ...
            @if(\App\Components\Helpers::systemConfig()['is_verify_register'])
                <div class="form-group">
                    <div class="row form-inline">
                        <div class="col-md-6 col-sm-6 col-xs-6" style="padding-right:0;">
                            <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="验证码" name="verify_code" value="{{Request::old('verify_code')}}" required />
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <input type="button" class="btn grey" id="sendCode" value="验证码" style="float:right;" onclick="sendVerifyCode()" >
                        </div>
                    </div>
                </div>
            @endif
        ...
        <div class="form-actions">
            ...
            @if(\App\Components\Helpers::systemConfig()['is_register'])
                <button type="submit" class="btn red pull-right">{{trans('register.submit')}}</button>
            @endif
        </div>
    </form>
