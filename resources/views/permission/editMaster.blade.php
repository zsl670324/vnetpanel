        ...
        <div class="tab-pane">
            <div class="portlet light bordered">
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    <form action="/permission/editMaster" method="post" class="form-horizontal" onsubmit="return do_submit();">
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="portlet light bordered">
                                        ...
                                        <div class="portlet-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 col-sm-9">
                                                    <input type="text" class="form-control" name="username" value="{{$master->username}}" id="username" placeholder="" autocomplete="off" autofocus required />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 col-sm-9">
                                                    <div class="input-group">
                                                        <input class="form-control" type="text" name="password" id="password" placeholder="留空则不修改" autocomplete="off" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 col-sm-9">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control" name="expire_time" value="{{$master->expire_time}}" id="expire_time" autocomplete="off" />
                                                        <span class="help-block">默认有效期1年</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="level" class="control-label col-md-2 col-sm-2">分销等级</label>
                                                <div class="col-md-9 col-sm-9">
                                                    <select class="form-control" name="level" id="level">
                                                        @foreach(config('common.master_level_map') as $key => $val)
                                                            <option value="{{$key}}" @if($master->level == $key) selected @endif>{{$val}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 col-sm-9">
                                                    <div class="input-group">
                                                        <input class="form-control" type="text" name="credit" value="{{$master->credit}}" id="credit" autocomplete="off" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 col-sm-9">
                                                    <textarea class="form-control" rows="4" name="remark" id="remark">{{$master->remark}}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="status" class="control-label col-md-2 col-sm-2">账户状态</label>
                                                <div class="col-md-9 col-sm-9">
                                                    <div class="mt-radio-inline">
                                                        <label class="mt-radio">
                                                            <input type="radio" name="status" value="1" @if($master->status) checked @endif /> 正常
                                                            <span></span>
                                                        </label>
                                                        <label class="mt-radio">
                                                            <input type="radio" name="status" value="0" @if(!$master->status) checked @endif /> 禁用
                                                            <span></span>
                                                        </label>
                                                    </div>
                                                </div>
