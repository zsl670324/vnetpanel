@if($message != '请使用安全码从<a href="/login?securityCode=" target="_self">安全入口</a>访问')
        <!DOCTYPE html>
...
<head>
    ...
    <script src="/argon/js/page.js"></script>
    <style type="text/css">
        @keyframes myan1 {
            0% {
    ...
    <style>
        ...
        #letter-g1, #letter-g6, #letter-g11, #letter-g16 {
            animation: myan1 3780ms ease infinite;
        }

        #letter-g2, #letter-g7, #letter-g12, #letter-g17 {
            animation: myan2 3780ms ease infinite;
        }

        #letter-g3, #letter-g8, #letter-g13, #letter-g18 {
            animation: myan3 3780ms ease infinite;
        }

        #letter-g4, #letter-g9, #letter-g14 {
            animation: myan4 3780ms ease infinite;
        }

        #letter-g5, #letter-g10, #letter-g15 {
            animation: myan5 3780ms ease infinite;
        }
    </style>
</head>
<body>
...
@else
    ...
    <div class="md:flex min-h-screen">
        <div class="w-full md:w-1/2 bg-white flex items-center justify-center">
            <div class="max-w-sm m-8">
                ...
                <p class="text-grey-darker text-2xl md:text-3xl font-light mb-8 leading-normal">{!! $message !!}</p>
                <form action="/login?securityCode=">
                    <input type="text"
                           class="bg-transparent text-grey-darkest font-bold uppercase tracking-wide py-3 px-6 border-2 border-grey-light hover:border-grey rounded-lg"
                           placeholder="请输入安全码" name="securityCode" id="securityCode">
                    <input type="submit"
                           class="bg-transparent text-grey-darkest font-bold uppercase tracking-wide py-3 px-6 border-2 border-grey-light hover:border-grey rounded-lg"
                           value="确认">
                </form>
        ...
        <div class="relative pb-full md:flex md:pb-0 md:min-h-screen w-full md:w-1/2">
            <div style="background-image: url(https://argon-dashboard-laravel.creative-tim.com/svg/404.svg);"
    ...
    <script type="text/javascript">window.NREUM || (NREUM = {});
        NREUM.info = {
            "beacon": "bam.nr-data.net",
            "licenseKey": "d4b21661da",
            "applicationID": "256134341",
            "transactionName": "ZwNUY0ADCkJWBURbX15Jd1RGCwtfGCdAQmx1HlVSQhYNXlkVbHpRXgJaUkAiFlRZAlVA",
            "queueTime": 5,
            "applicationTime": 56,
            "atts": "S0RXFQgZGUw=",
            "errorBeacon": "bam.nr-data.net",
